...
Requirements Engineering MCP participates in the **MCP File Exchange** convention,
...
from reqeng_mcp.server import get_file_exchange
...
block in `src/reqeng_mcp/server.py` (inside the
